...
export const actionToggleDashboardType = (payload:boolean):ActionToggleDashboardType => ({
...
const isDashboardRoutine = (state=initialState, action:ActionToggleDashboardType):boolean => {
    switch(action.type) {
