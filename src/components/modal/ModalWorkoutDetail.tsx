...
const ModalWorkoutDetail = ({
    ...
    let {id, title, instruction, category, tool, image, setCount, count, breakTime, part} = workoutDetail
    return (
        <Frame>
            <ModalTop><input type="button" value="X" onClick={offWorkoutModal}/></ModalTop>
            ...
            <Wrap>
                ...
                <Description>
                    <Summary>
                        ...
                        <Explanation>{image.length === 1?`${count} sec`:`${count} 회`}</Explanation>
                    ...
                    <ControlBtn>
                        <SaveBtn type="button" value="SAVE IT!" onClick={() => saveOrRemoveWorkout(id)}/>
                    </ControlBtn>
                </Description>
            </Wrap>
        </Frame>
